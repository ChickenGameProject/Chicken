...
const QMetaObject Chicken::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Chicken.data,
      qt_meta_data_Chicken,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Chicken::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Chicken.stringdata0))
        return static_cast<void*>(const_cast< Chicken*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Chicken*>(this));
